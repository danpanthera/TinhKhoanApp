  ...
  <div class="modern-dashboard">
    ...
    <div class="quantum-grid">
      <div 
        ...
        :key="indicator.id"
        class="quantum-card"
        :class="[indicator.class, { 'loading': loading, 'quantum-pulse': loading }]"
        :style="{ 
      ...
      >
        ...
        <div class="floating-icon-container">
          <div class="icon-orbit">
            ...
            <div class="quantum-icon">{{ indicator.icon }}</div>
          </div>
        </div>
        
        <!-- Card Header -->
        <div class="quantum-header">
          <h3 class="quantum-title">{{ indicator.name }}</h3>
        ...
        <div class="quantum-body">
          <!-- Value Display with Holographic Effect -->
          <div class="value-display">
            <div class="value-wrapper">
              <div class="holographic-number">
                <animated-number
              ...
              <span class="value-unit-quantum">{{ indicator.unit }}</span>
            </div>
            ...
            <div class="progress-3d-container">
              <div class="progress-ring-3d">
                <svg class="progress-svg" viewBox="0 0 120 120">
                  <defs>
                    <linearGradient :id="`gradient-${indicator.id}`" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" :style="`stop-color: var(--card-color); stop-opacity: 1`" />
                      <stop offset="100%" :style="`stop-color: var(--card-color-light); stop-opacity: 0.8`" />
                    </linearGradient>
                  ...
                  <circle
                    ...
                    r="50"
                    fill="none"
                    :stroke="`url(#gradient-${indicator.id})`"
                    stroke-width="8"
                    stroke-linecap="round"
                    :stroke-dasharray="314"
                    :stroke-dashoffset="314 - (314 * indicator.completionRate / 100)"
                  ...
                  <text
                    ...
                    font-weight="bold"
                  >
                    {{ Math.round(indicator.completionRate) }}%
                  </text>
                </svg>
              </div>
            </div>
          ...
          <!-- Comparison with Quantum Effects -->
          <div class="quantum-comparison">
            <div class="comparison-header">
              <span class="comparison-label">So với đầu năm</span>
            </div>
            <div class="comparison-data">
              <div class="trend-indicator" :class="indicator.changeFromYearStart >= 0 ? 'trend-up' : 'trend-down'">
                <div class="trend-arrow">
                  <i :class="indicator.changeFromYearStart >= 0 ? 'arrow-up' : 'arrow-down'">
                ...
                <div class="trend-values">
                  ...
                  <span class="percent-value" :class="indicator.changeFromYearStart >= 0 ? 'positive' : 'negative'">
        ...
        <div class="quantum-footer">
          <div class="footer-stats">
            <div class="stat-item">
              ...
              <span class="stat-value">{{ formatNumber(indicator.targetValue) }}</span>
            </div>
            <div class="stat-divider"></div>
            <div class="stat-item">
              <span class="stat-label">Actual</span>
              <span class="stat-value">{{ formatNumber(indicator.currentValue) }}</span>
            </div>
          </div>
          ...
          <div class="performance-gauge">
            ...
            <div 
              class="gauge-fill" 
              :style="{ width: Math.min(indicator.completionRate, 100) + '%' }"
            ></div>
          </div>
        </div>
      </div>
    ...
    <div v-if="loading" class="quantum-loading">
      ...
      <div class="loading-container">
        ...
        <div class="loading-text">
          <div class="loading-title">Đang tải dữ liệu...</div>
