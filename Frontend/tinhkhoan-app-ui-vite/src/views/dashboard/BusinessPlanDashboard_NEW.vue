...
const loadIndicators = async () => {
  try {
    ...
    indicators.value = [
      ...
      { code: 'DuNo', name: 'Dư nợ cho vay' },
      { code: 'TyLeNoXau', name: 'Tỷ lệ nợ xấu' },
      { code: 'DoanhThu', name: 'Doanh thu' },
      { code: 'LoiNhuan', name: 'Lợi nhuận' },
      { code: 'KhachHang', name: 'Khách hàng mới' }
    ];
  }
};
  ...
  try {
    ...
    dashboardData.value = [
      ...
      },
      {
        ...
        dataDate: new Date(),
        yoyGrowth: 18.7,
        trend: [800, 900, 950, 1000, 1100, 1250]
      }
    ];
    ...
    monthlyTrendData.value = {
      ...
      series: [
        {
          name: 'Huy động vốn',
          data: [1000, 1100, 1050, 1200, 1150, 1200],
          color: '#8B1538'
        },
        {
          name: 'Dư nợ cho vay',
          data: [2000, 2100, 2200, 2350, 2400, 2800],
          color: '#A6195C'
        }
      ]
    };
