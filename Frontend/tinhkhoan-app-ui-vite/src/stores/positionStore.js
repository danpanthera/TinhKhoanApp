  ...
  actions: {
    async fetchPositions() {
      ...
      try {
        ...
        this.positions = []
        this.error = 'Không thể tải danh sách chức vụ. Lỗi: ' + (err.response?.data?.message || err.message)
    ...
    async createPosition(positionData) {
      ...
      try {
        ...
        this.error =
          'Không thể tạo chức vụ. Lỗi: ' + (err.response?.data?.message || err.response?.data?.title || err.message)
        console.error('Lỗi khi createPosition:', err.response?.data || err.message, err)
        throw err
      } finally {
        this.isLoading = false
      }
    ...
    async updatePosition(positionData) {
      ...
      try {
        ...
        console.error('Lỗi khi updatePosition:', err.response?.data || err.message, err)
        throw err
      } finally {
        this.isLoading = false
      }
    ...
    async deletePosition(positionId) {
      ...
      try {
        ...
        this.error =
          'Không thể xóa chức vụ. Lỗi: ' + (err.response?.data?.message || err.response?.data?.title || err.message)
        console.error('Lỗi khi deletePosition:', err.response?.data || err.message, err)
        throw err
      } finally {
        this.isLoading = false
      }
