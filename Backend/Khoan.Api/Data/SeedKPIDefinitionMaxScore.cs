...
namespace Khoan.Api.Data
{
    ...
    public static class SeedKPIDefinitionMaxScore
    {
        ...
        private static void SeedTruongphongKhdn(ApplicationDbContext context)
        {
            ...
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng Dư nợ KHDN", Description = "Tổng dư nợ khách hàng doanh nghiệp", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Thu nợ đã XLRR KHDN", Description = "Thu nợ đã xử lý rủi ro khách hàng doanh nghiệp", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedTruongphongKhcn(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng Dư nợ KHCN", Description = "Tổng dư nợ khách hàng cá nhân", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Thu nợ đã XLRR KHCN", Description = "Thu nợ đã xử lý rủi ro khách hàng cá nhân", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedTruongphongKhqlrr(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng nguồn vốn", Description = "Tổng nguồn vốn", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Tổng dư nợ", Description = "Tổng dư nợ", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedCbtd(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng dư nợ BQ", Description = "Tổng dư nợ bình quân", MaxScore = 30, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Thu nợ đã XLRR (nếu không có nợ XLRR thì cộng vào chỉ tiêu Dư nợ)", Description = "Thu nợ đã xử lý rủi ro (nếu không có nợ XLRR thì cộng vào chỉ tiêu Dư nợ)", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_07", KpiName = "Tổng nguồn vốn huy động BQ", Description = "Tổng nguồn vốn huy động bình quân", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedTruongphongKtnqCnl1(ApplicationDbContext context)
        {
            ...
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng nguồn vốn", Description = "Tổng nguồn vốn", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Thu dịch vụ thanh toán trong nước", Description = "Thu dịch vụ thanh toán trong nước", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedGdv(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_05", KpiName = "Tổng nguồn vốn huy động BQ", Description = "Tổng nguồn vốn huy động bình quân", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedTruongphongItThKtgs(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Tổng nguồn vốn huy động BQ", Description = "Tổng nguồn vốn huy động bình quân", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedGiamdocPgd(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng nguồn vốn BQ", Description = "Tổng nguồn vốn bình quân", MaxScore = 15, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Tổng dư nợ BQ", Description = "Tổng dư nợ bình quân", MaxScore = 15, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_05", KpiName = "Thu nợ đã XLRR (nếu không có thì cộng vào chỉ tiêu dư nợ)", Description = "Thu nợ đã xử lý rủi ro (nếu không có thì cộng vào chỉ tiêu dư nợ)", MaxScore = 5, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_06", KpiName = "Thu dịch vụ", Description = "Thu dịch vụ", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_07", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 15, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedPhogiamdocPgdCbtd(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Tỷ lệ nợ xấu", Description = "Tỷ lệ nợ xấu", MaxScore = 15, ValueType = KpiValueType.PERCENTAGE, UnitOfMeasure = "%", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Phát triển Khách hàng", Description = "Phát triển khách hàng mới", MaxScore = 10, ValueType = KpiValueType.NUMBER, UnitOfMeasure = "Khách hàng", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Thu nợ đã XLRR (nếu không có thì cộng vào chỉ tiêu dư nợ)", Description = "Thu nợ đã xử lý rủi ro (nếu không có thì cộng vào chỉ tiêu dư nợ)", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_05", KpiName = "Thực hiện nhiệm vụ theo chương trình công tác", Description = "Thực hiện nhiệm vụ theo chương trình công tác", MaxScore = 10, ValueType = KpiValueType.PERCENTAGE, UnitOfMeasure = "%", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_06", KpiName = "Tổng nguồn vốn huy động BQ", Description = "Tổng nguồn vốn huy động bình quân", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedGiamdocCnl2(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng nguồn vốn cuối kỳ", Description = "Tổng nguồn vốn cuối kỳ", MaxScore = 5, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Tổng nguồn vốn huy động BQ trong kỳ", Description = "Tổng nguồn vốn huy động bình quân trong kỳ", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Tổng dư nợ cuối kỳ", Description = "Tổng dư nợ cuối kỳ", MaxScore = 5, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Tổng dư nợ BQ trong kỳ", Description = "Tổng dư nợ bình quân trong kỳ", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_05", KpiName = "Tổng dư nợ HSX&CN", Description = "Tổng dư nợ hợp tác xã và chủ nợ", MaxScore = 5, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_07", KpiName = "Thu nợ đã XLRR", Description = "Thu nợ đã xử lý rủi ro", MaxScore = 5, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                ...
                new KPIDefinition { KpiCode = $"{roleCode}_09", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_10", KpiName = "Thu dịch vụ", Description = "Thu dịch vụ", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedPhogiamdocCnl2Td(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng dư nợ cho vay", Description = "Tổng dư nợ cho vay", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Tổng dư nợ cho vay HSX&CN", Description = "Tổng dư nợ cho vay hợp tác xã và chủ nợ", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Thu nợ đã xử lý", Description = "Thu nợ đã xử lý", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedPhogiamdocCnl2Kt(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng nguồn vốn", Description = "Tổng nguồn vốn", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Lợi nhuận khoán tài chính", Description = "Lợi nhuận khoán tài chính", MaxScore = 30, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Tổng doanh thu phí dịch vụ", Description = "Tổng doanh thu phí dịch vụ", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
        ...
        private static void SeedTruongphongKhCnl2(ApplicationDbContext context)
        {
            ...
            var kpiDefinitions = new List<KPIDefinition>
            {
                new KPIDefinition { KpiCode = $"{roleCode}_01", KpiName = "Tổng dư nợ", Description = "Tổng dư nợ", MaxScore = 20, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_02", KpiName = "Tỷ lệ nợ xấu", Description = "Tỷ lệ nợ xấu", MaxScore = 15, ValueType = KpiValueType.PERCENTAGE, UnitOfMeasure = "%", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_03", KpiName = "Phát triển Khách hàng", Description = "Phát triển khách hàng mới", MaxScore = 10, ValueType = KpiValueType.NUMBER, UnitOfMeasure = "Khách hàng", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
                new KPIDefinition { KpiCode = $"{roleCode}_04", KpiName = "Thu nợ đã XLRR", Description = "Thu nợ đã xử lý rủi ro", MaxScore = 10, ValueType = KpiValueType.CURRENCY, UnitOfMeasure = "Triệu VND", IsActive = true, Version = "1.0", CreatedDate = DateTime.UtcNow },
