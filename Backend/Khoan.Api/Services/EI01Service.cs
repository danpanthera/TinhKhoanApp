...
namespace Khoan.Api.Services
{
    ...
    private readonly IEI01Repository _repository;
        ...
        private EI01PreviewDto MapToPreviewDto(DataTables.EI01 entity)
        {
        ...
        private EI01DetailsDto MapToDetailsDto(DataTables.EI01 entity)
        {
            return new EI01DetailsDto
            {
                ...
                CreatedAt = entity.CREATED_DATE,
                UpdatedAt = entity.UPDATED_DATE,
                SysStartTime = default,
                SysEndTime = default
            };
        }

        private DataTables.EI01 MapFromCreateDto(EI01CreateDto dto)
        {
            return new DataTables.EI01
            {
                NGAY_DL = dto.NGAY_DL,
        ...
        private void MapFromUpdateDto(EI01UpdateDto dto, DataTables.EI01 entity)
        {
