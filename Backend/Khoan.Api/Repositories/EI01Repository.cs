...
namespace Khoan.Api.Repositories
{
    ...
    /// </summary>
    public class EI01Repository : Repository<DataTables.EI01>, IEI01Repository
    {
        ...
        /// </summary>
    public new async Task<IEnumerable<DataTables.EI01>> GetRecentAsync(int count = 10)
        {
            return await _dbSet
        ...
        /// </summary>
        public async Task<IEnumerable<DataTables.EI01>> GetByDateAsync(DateTime date)
        {
            return await _dbSet
        ...
        /// </summary>
    public async Task<IEnumerable<DataTables.EI01>> GetByBranchCodeAsync(string branchCode, int maxResults = 100)
        {
            return await _dbSet
        ...
        /// </summary>
    public async Task<IEnumerable<DataTables.EI01>> GetByCustomerCodeAsync(string customerCode, int maxResults = 100)
        {
            return await _dbSet
        ...
        /// </summary>
    public async Task<IEnumerable<DataTables.EI01>> GetByCustomerTypeAsync(string customerType, int maxResults = 100)
        {
            return await _dbSet
        ...
        /// </summary>
        public async Task<IEnumerable<DataTables.EI01>> GetByPhoneNumberAsync(string phoneNumber, int maxResults = 100)
        {
            return await _dbSet
                .Where(ei01 =>
        ...
        /// </summary>
    public async Task<IEnumerable<DataTables.EI01>> GetByEMBStatusAsync(string status, int maxResults = 100)
        {
            return await _dbSet
        ...
        /// </summary>
    public async Task<IEnumerable<DataTables.EI01>> GetByOTTStatusAsync(string status, int maxResults = 100)
        {
            return await _dbSet
        ...
        /// </summary>
    public async Task<IEnumerable<DataTables.EI01>> GetBySMSStatusAsync(string status, int maxResults = 100)
        {
            return await _dbSet
        ...
        /// </summary>
        public async Task<IEnumerable<DataTables.EI01>> GetByRegistrationDateRangeAsync(DateTime fromDate, DateTime toDate, string serviceType, int maxResults = 100)
        {
            ...
            switch (serviceType.ToUpper())
            {
                ...
                default:
                    ...
                    return Enumerable.Empty<DataTables.EI01>().ToList();
            }
        ...
        /// Cập nhật nhiều EI01
        /// </summary>
        public void UpdateRange(IEnumerable<DataTables.EI01> entities)
        {
