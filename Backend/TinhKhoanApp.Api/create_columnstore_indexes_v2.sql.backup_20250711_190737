-- 📊 TẠO COLUMNSTORE INDEXES CHO TẤT CẢ BẢNG DỮ LIỆU THÔ - VERSION 2
-- Script này tạo Columnstore Indexes chỉ với các cột chung để tránh lỗi

USE TinhKhoanDB;
GO

PRINT N'🚀 Bắt đầu tạo Columnstore Indexes với cột chung cho tất cả bảng dữ liệu thô...';
