        ...
        public async Task<ActionResult> ReplaceOrganizationalStructure()
        {
            try
            {
                ...
                var combinedSql = @"
                    ...
                    (9, 'CnBinhLu', N'Chi nhánh Bình Lư', 'CNL2', 1),
                    (10, 'CnBinhLuBgd', N'Ban Giám đốc', 'PNVL2', 9),
                    (11, 'CnBinhLuKtnq', N'Phòng Kế toán & Ngân quỹ', 'PNVL2', 9),
                    (12, 'CnBinhLuKh', N'Phòng Khách hàng', 'PNVL2', 9),
                    ...
                    (17, 'CnPhongThoPgdSo5', N'Phòng giao dịch Số 5', 'PGDL2', 13),
                    ...
                    (22, 'CnBumTo', N'Chi nhánh Bum Tở', 'CNL2', 1),
                    (23, 'CnBumToBgd', N'Ban Giám đốc', 'PNVL2', 22),
                    (24, 'CnBumToKtnq', N'Phòng Kế toán & Ngân quỹ', 'PNVL2', 22),
                    (25, 'CnBumToKh', N'Phòng Khách hàng', 'PNVL2', 22),
                    ...
                    (30, 'CnThanUyenPgdSo6', N'Phòng giao dịch Số 6', 'PGDL2', 26),
                    (31, 'CnDoanKet', N'Chi nhánh Đoàn Kết', 'CNL2', 1),
                    (32, 'CnDoanKetBgd', N'Ban Giám đốc', 'PNVL2', 31),
                    (33, 'CnDoanKetKtnq', N'Phòng Kế toán & Ngân quỹ', 'PNVL2', 31),
                    (34, 'CnDoanKetKh', N'Phòng Khách hàng', 'PNVL2', 31),
                    (35, 'CnDoanKetPgdSo1', N'Phòng giao dịch số 1', 'PGDL2', 31),
                    (36, 'CnDoanKetPgdSo2', N'Phòng giao dịch số 2', 'PGDL2', 31),
                    ...
                    (42, 'CnNamHang', N'Chi nhánh Nậm Hàng', 'CNL2', 1),
                    (43, 'CnNamHangBgd', N'Ban Giám đốc', 'PNVL2', 42),
                    (44, 'CnNamHangKtnq', N'Phòng Kế toán & Ngân quỹ', 'PNVL2', 42),
                    (45, 'CnNamHangKh', N'Phòng Khách hàng', 'PNVL2', 42);
