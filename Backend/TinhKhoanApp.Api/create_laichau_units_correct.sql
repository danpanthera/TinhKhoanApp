...
-- =============================================
-- LV1: ROOT - Chi nhánh Lai Châu
-- =============================================

INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
(1, 'CN_LAICHAU', N'Chi nhánh Lai Châu', 'CNL1', NULL, 0);

PRINT '✅ Đã tạo ROOT: Chi nhánh Lai Châu'

-- =============================================
-- LV2: Hội Sở + 8 Chi nhánh cấp 2
-- =============================================

-- Hội Sở
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
(2, 'HOISO', N'Hội Sở', 'CNL2', 1, 0);
...
PRINT '✅ Đã tạo 9 đơn vị LV2: 1 Hội Sở + 8 Chi nhánh'

-- =============================================
-- LV3: Phòng ban thuộc Hội Sở (7 phòng)
-- =============================================
...
PRINT '✅ Đã tạo 7 phòng ban thuộc Hội Sở'

-- =============================================
-- LV3: 24 Phòng ban + 5 PGD thuộc 8 chi nhánh
-- =============================================

-- Chi nhánh Bình Lư (ID=10): 3 phòng ban
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
-- Chi nhánh Phong Thổ (ID=11): 3 phòng ban + 1 PGD
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
(24, 'PGD_SO5', N'Phòng giao dịch Số 5', 'PGDL2', 11, 0);

-- Chi nhánh Sìn Hồ (ID=12): 3 phòng ban
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
-- Chi nhánh Bum Tở (ID=13): 3 phòng ban
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
-- Chi nhánh Than Uyên (ID=14): 3 phòng ban + 1 PGD
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
(34, 'PGD_SO6', N'Phòng giao dịch số 6', 'PGDL2', 14, 0);

-- Chi nhánh Đoàn Kết (ID=15): 3 phòng ban + 2 PGD
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
(38, 'PGD_SO1', N'Phòng giao dịch số 1', 'PGDL2', 15, 0),
(39, 'PGD_SO2', N'Phòng giao dịch số 2', 'PGDL2', 15, 0);

-- Chi nhánh Tân Uyên (ID=16): 3 phòng ban + 1 PGD
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
(43, 'PGD_SO3', N'Phòng giao dịch số 3', 'PGDL2', 16, 0);

-- Chi nhánh Nậm Hàng (ID=17): 3 phòng ban
INSERT INTO Units (Id, Code, Name, Type, ParentUnitId, IsDeleted) VALUES
...
PRINT '✅ Đã tạo 29 đơn vị LV3: 24 phòng ban + 5 PGD'
...
PRINT ''
PRINT '📊 THỐNG KÊ CẤU TRÚC CÂY 3 CẤP:'
PRINT 'LV1 (ROOT): 1 đơn vị - Chi nhánh Lai Châu'
PRINT 'LV2 (Chi nhánh): 9 đơn vị - 1 Hội Sở + 8 Chi nhánh'
PRINT 'LV3 (Phòng ban + PGD): 36 đơn vị - 7 P.Hội Sở + 24 P.Chi nhánh + 5 PGD'
PRINT 'TỔNG CỘNG: ' + CAST(@total_count AS NVARCHAR(10)) + ' đơn vị'

IF @total_count = 46
    PRINT '🎉 THÀNH CÔNG: Đã tạo đúng 46 đơn vị theo cấu trúc cây 3 cấp!'
ELSE
