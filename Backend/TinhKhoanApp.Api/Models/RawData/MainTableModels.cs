...
{
    // =======================================
    // 📊 7800_DT_KHKD1 - Báo cáo kế hoạch kinh doanh Model (Main Table)
    // =======================================
    [Table("7800_DT_KHKD1")]
    public class DT_KHKD1 : IExtendedHistoryModel
    {
        [Key]
    ...
    // =======================================
    // 📊 GLCB41 - Dữ liệu sổ cái chi tiết Model (Main Table)
    // =======================================
    [Table("GLCB41")]
    public class GLCB41 : IExtendedHistoryModel
    {
        [Key]
        public int Id { get; set; }
